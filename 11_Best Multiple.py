# so we've shown some examples that look promising,
# but we're unsure about their variables, and we're not sure
# they wholistically beat doubler. Let's begin to work out that stuff.
# The question is, can we find a simple variable change where
# there is both lower risk, and higher profit... and soon,
# is this the case across an average of 1 million samples.
...
while x < 10000:
    ...
    if ((multiple_busts / multipleSampSize) * 100.00 < lower_bust) and (
            (multiple_profits / multipleSampSize) * 100.00 > higher_profit):
        print(('#################################################'))
